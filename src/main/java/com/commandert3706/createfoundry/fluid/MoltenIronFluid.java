...
public class MoltenIronFluid extends FlowableFluid {
    public Fluid getFlowing() {
        return ModFluids.MOLTEN_IRON_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.MOLTEN_IRON_STILL;
    }

    public Item getBucketItem() {
        return MiscItems.MOLTEN_IRON_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.MOLTEN_IRON_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.MOLTEN_IRON_STILL || fluid == ModFluids.MOLTEN_IRON_FLOWING;
    }
