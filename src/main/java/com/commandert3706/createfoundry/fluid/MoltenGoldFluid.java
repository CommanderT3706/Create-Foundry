...
public class MoltenGoldFluid extends FlowableFluid {
    public Fluid getFlowing() {
        return ModFluids.MOLTEN_GOLD_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.MOLTEN_GOLD_STILL;
    }

    public Item getBucketItem() {
        return MiscItems.MOLTEN_GOLD_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.MOLTEN_GOLD_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.MOLTEN_GOLD_STILL || fluid == ModFluids.MOLTEN_GOLD_FLOWING;
    }
