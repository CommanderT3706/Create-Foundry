...
public class ModFluidTypes {
    public static final ResourceLocation STILL = new ResourceLocation("createfoundry", "block/base_still");
    public static final ResourceLocation FLOWING = new ResourceLocation("createfoundry", "block/base_flow");

    public static final FluidType.Properties DEFAULT_FLUID = FluidType.Properties.create()
            .lightLevel(7).viscosity(3000).density(6000).temperature(1600).sound(SoundAction.get("empty"), SoundEvents.BUCKET_EMPTY_LAVA)
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties,
        ...
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL, FLOWING,
